...
Gliders mounted inside a rocket are very challenging to be designed. Complex navigation instrumentation cannot be mounted on the gliders, due to space and weight constraints. We are thus proposing two solutions, one using RTK GPS and the other one using Ultrawide beacons.
...
\paragraph{Navigation using Ultrawide beacons}
\hfill \break
